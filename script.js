...
(() => {
    const calculatorTest = () => {
        ...
        const takeInputTwo = () => {
            if ((numTwo.innerText === "2") && (a.length < 10) && (finish === false)) {
                a = a + 2;
                out.textContent = a;
            } else if ((numTwo.innerText === "2") && (b.length < 10) && (finish === true)) {
                b = b + 2;
                out.textContent = b;
            }
        }
        ...
        const takeInputThree = () => {
            if ((numThree.innerText === "3") && (a.length < 10) && (finish === false)) {
                a = a + 3;
                out.textContent = a;
            } else if ((numThree.innerText === "3") && (b.length < 10) && (finish === true)) {
                b = b + 3;
                out.textContent = b;
            }
        }
        ...
        const takeInputFour = () => {
            if ((numFour.innerText === "4") && (a.length < 10) && (finish === false)) {
                a = a + 4;
                out.textContent = a;
            } else if ((numFour.innerText === "4") && (b.length < 10) && (finish === true)) {
                b = b + 4;
                out.textContent = b;
            }
        }
        ...
        const takeInputFive = () => {
            if ((numFive.innerText === "5") && (a.length < 10) && (finish === false)) {
                a = a + 5;
                out.textContent = a;
            } else if ((numFive.innerText === "5") && (b.length < 10) && (finish === true)) {
                b = b + 5;
                out.textContent = b;
            }
        }
        ...
        const takeInputSix = () => {
            if ((numSix.innerText === "6") && (a.length < 10) && (finish === false)) {
                a = a + 6;
                out.textContent = a;
            } else if ((numSix.innerText === "6") && (b.length < 10) && (finish === true)) {
                b = b + 6;
                out.textContent = b;
            }
        }
        ...
        const takeInputSeven = () => {
            if ((numSeven.innerText === "7") && (a.length < 10) && (finish === false)) {
                a = a + 7;
                out.textContent = a;
            } else if ((numSeven.innerText === "7") && (b.length < 10) && (finish === true)) {
                b = b + 7;
                out.textContent = b;
            }
        }
        ...
        const takeInputEight = () => {
            if ((numEight.innerText === "8") && (a.length < 10) && (finish === false)) {
                a = a + 8;
                out.textContent = a;
            } else if ((numEight.innerText === "8") && (b.length < 10) && (finish === true)) {
                b = b + 8;
                out.textContent = b;
            }
        }
        ...
        const takeInputNine = () => {
            if ((numNine.innerText === "9") && (a.length < 10) && (finish === false)) {
                a = a + 9;
                out.textContent = a;
            } else if ((numNine.innerText === "9") && (b.length < 10) && (finish === true)) {
                b = b + 9;
                out.textContent = b;
            }
        }
        ...
        const takeInputZero = () => {
            if ((numZero.innerText === "0") && (a.length < 10) && (finish === false)) {
                a = a + 0;
                out.textContent = a;
            } else if ((numZero.innerText === "0") && (b.length < 10) && (finish === true)) {
                b = b + 0;
                out.textContent = b;
            }
        }
        ...
        const takeInputDot = () => {
            if ((numDot.innerText === ".") && (a.length < 10) && (finish === false) && (!a.split("").includes("."))) {
                a = a + ".";
                out.textContent = a;
            } else if ((numDot.innerText === ".") && (b.length < 10) && (finish === true) && (!b.split("").includes("."))) {
                b = b + ".";
                out.textContent = b;
            }
        }
